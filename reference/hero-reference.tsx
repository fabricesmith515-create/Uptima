/**
 * ============================================================================
 * RÉFÉRENCE DESIGN — NE PAS IMPORTER DANS L'APPLICATION
 * ============================================================================
 * Composant de référence issu de motionsites.ai (« Axion Studio »).
 * Stack d'origine : React 18 + Vite + Tailwind CSS 3.4 + `shaders` + lucide-react.
 *
 * Ce fichier sert uniquement de source au design system d'Uptima :
 * voir DESIGN-SYSTEM.md pour l'extraction des tokens (couleurs, typo,
 * espacements, animations, composants).
 * ============================================================================
 */
...
/* Icône starburst/compas du badge partenaire */
...
/* Icône « lien/chaîne » (lucide link) dessinée manuellement */
...
/* Horloge de Londres, mise à jour chaque seconde */
...
/* Bouton avec animation « text roll » au survol */
...
export default function AxionStudioReference() {
  ...
  return (
    <main className="antialiased text-gray-900">
      ...
      <section className="relative min-h-screen flex flex-col bg-[#EFEFEF] overflow-hidden">
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-50">
            ...
            <div className="absolute bottom-0 left-0 right-0 mx-3 mb-3 bg-white rounded-2xl p-6 translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <span className="flex items-center gap-1.5 text-[13px] text-gray-600">
                <Clock size={14} />
                {londonTime} in London
              </span>
              <div className="mt-6 flex flex-col gap-4">
                {["Projects", "Studio", "Journal", "Connect"].map((link) => (
                  <a key={link} href="#" className="text-[28px] leading-[32px] font-medium text-gray-900">
                    {link}
                  </a>
                ))}
              </div>
              <a
                href="#"
                className="group mt-8 flex items-center justify-between bg-gray-900 text-white text-[14px] font-medium rounded-full pl-5 pr-2 py-2"
              >
                Start a project
        ...
        <div className="relative z-20 max-w-[1440px] mx-auto w-full px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-5">
            <a
              href="#"
              className="group inline-flex items-center gap-2 self-start bg-[#F26522] hover:bg-[#e05a1a] text-white text-[13px] sm:text-[14px] font-medium rounded-full pl-5 sm:pl-6 pr-2 py-2 transition-colors duration-300"
            >
            ...
            <div className="inline-flex items-center gap-2 self-start bg-white rounded-[4px] px-3 py-2 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-shadow duration-300">
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="lg:hidden px-5 sm:px-8 flex flex-col gap-8">
            <p className="text-[15px] sm:text-[17px] leading-[1.6] font-medium text-gray-900">
              Through research, creative thinking and iteration we help growing brands realize their digital full
              potential.
            </p>
            <a
              href="#"
              className="group inline-flex items-center gap-2 self-start bg-[#F26522] hover:bg-[#e05a1a] text-white text-[13px] font-medium rounded-full pl-5 pr-2 py-2 transition-colors duration-300"
            >
          ...
          <div className="hidden lg:grid grid-cols-[26%_1fr_48%] items-end gap-6 xl:gap-8 px-12">
            <img
              src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090123_74be96d4-9c1b-40cf-932a-96f4f4babed3.png&w=1280&q=85"
              alt="Studio"
              className="self-end aspect-[438/346] rounded-2xl object-cover"
            />
            ...
            <img
              src="https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260516_090133_c157d30b-a99a-4477-bec1-a446149ec3f2.png&w=1280&q=85"
              alt="Work"
              className="self-end aspect-[3/2] rounded-2xl object-cover"
            />
          </div>
        </div>
      </section>
      ...
      {/* ================================================================ */}
      {/* SECTION 3 — CASE STUDIES (fond #F5F5F5)                           */}
      {/* ================================================================ */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7 px-5 sm:px-8 lg:px-12">
            ...
            <div>
              <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
                ...
                />
                <div className="absolute bottom-4 left-4 flex items-center h-9 w-9 group-hover:w-[148px] bg-white rounded-full px-[11px] overflow-hidden transition-all duration-300 ease-in-out">
                  <LinkIcon className="shrink-0 -rotate-45 group-hover:rotate-0 transition-transform duration-300" />
            ...
            <div>
              <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
                <video
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-4 left-4 flex items-center h-9 w-9 group-hover:w-[168px] bg-gray-900 rounded-full px-[11px] overflow-hidden transition-all duration-300 ease-in-out">
                  <ArrowRight size={14} className="shrink-0 text-white -rotate-45 group-hover:rotate-0 transition-transform duration-300" />
